  ...
  return (
    ...
    >
      <div className="bg-white bg-opacity-90 flex flex-col md:flex-row items-center md:p-10 relative z-10">
        ...
        <div ref={textRef} className="md:w-1/2 pl-3 md:pl-0 pr-3 md:pr-0 pb-5 md:pb-0 -mt-10 md:-mt-0 flex flex-col justify-center">
          ...
          <p className="md:text-start text-xs md:text-base">
            With a solid reputation built on quality and reliability, we offer a comprehensive range of steel products sourced from industry leaders. Our commitment to excellence drives us to deliver not only materials but also innovative solutions tailored to meet the diverse needs of our clients across various sectors. At Premier Steels, we pride ourselves on exceptional customer service, technical expertise, and timely delivery, ensuring that your projects run smoothly from start to finish. Join us in building a stronger future with <strong className="font-semibold">Premier Steels</strong>.
          </p>
